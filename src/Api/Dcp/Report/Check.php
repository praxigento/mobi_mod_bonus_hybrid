    ...
    implements \Praxigento\BonusHybrid\Api\Dcp\Report\CheckInterface
{
    ...
    /** @var \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\Authorize */
    private $procAuthorize;
    /** @var \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\ComposeResponse */
    private $procComposeResp;
    /** @var \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\MineData */
    private $procMineData;
    /** @var \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\ParseRequest */
    private $procParseRequest;

    public function __construct(
        \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\Authorize $procAuthorize,
        \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\ComposeResponse $procComposeResp,
        \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\MineData $procMineData,
        \Praxigento\BonusHybrid\Api\Dcp\Report\Check\Fun\Proc\ParseRequest $procParseRequest
    )
    {
