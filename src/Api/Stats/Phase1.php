    ...
    implements \Praxigento\BonusHybrid\Api\Stats\Phase1Interface
{
    ...
    protected function populateQuery(\Flancer32\Lib\Data $ctx)
    {
        ...
        $where = \Praxigento\BonusHybrid\Repo\Query\Stats\Phase1\Builder::AS_TREE . '.' .
            \Praxigento\BonusHybrid\Repo\Data\Entity\Compression\Ptc::ATTR_PATH . ' LIKE :' . self::BIND_PATH;
        ...
        if (!is_null($maxDepth)) {
            ...
            $where = \Praxigento\BonusHybrid\Repo\Query\Stats\Phase1\Builder::AS_TREE . '.' .
                \Praxigento\BonusHybrid\Repo\Data\Entity\Compression\Ptc::ATTR_DEPTH . ' < :' . self::BIND_MAX_DEPTH;
            $query->where($where);
        ...
        $where = \Praxigento\BonusHybrid\Repo\Query\Stats\Phase1\Builder::AS_TREE . '.' .
            \Praxigento\BonusHybrid\Repo\Data\Entity\Compression\Ptc::ATTR_CALC_ID . ' = :' . self::BIND_CALC_REF;
        $query->where($where);
