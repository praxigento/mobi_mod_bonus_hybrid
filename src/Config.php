...
class Config extends BonusBaseCfg
{
    ...
    const CODE_TYPE_CALC_COMPRESS_FOR_OI_DEF = 'HYBRID_COMPRESS_FOR_OI_DEF'; // Override & Infinity (DEFAULT scheme)
    const CODE_TYPE_CALC_COMPRESS_FOR_OI_EU = 'HYBRID_COMPRESS_FOR_OI_EU'; // Override & Infinity (EU scheme)
    const CODE_TYPE_CALC_COMPRESS_FOR_PTC = 'HYBRID_COMPRESS_FOR_PTC'; // Compression for Personal, Team & Courtesy
